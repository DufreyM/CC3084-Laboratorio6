...
plt.tight_layout()
plt.savefig(FIGS / "01_top_canales_comentarios.png", dpi=120, bbox_inches="tight", pad_inches=0.3)
plt.close()
...
plt.xlabel("Numero de comentarios")
plt.tight_layout()
plt.savefig(FIGS / "02_top_videos_comentarios.png", dpi=120, bbox_inches="tight", pad_inches=0.3)
plt.close()
...
plt.tight_layout()
plt.savefig(FIGS / "03_histograma_views.png", dpi=120, bbox_inches="tight", pad_inches=0.3)
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig(FIGS / "04_categorias_video_vs_comentario.png", dpi=120, bbox_inches="tight", pad_inches=0.3)
plt.close()
...
plt.tight_layout()
plt.savefig(FIGS / "05_scatter_views_vs_comentarios.png", dpi=120, bbox_inches="tight", pad_inches=0.3)
plt.close()
...
plt.tight_layout()
plt.savefig(FIGS / "06_top_palabras.png", dpi=120, bbox_inches="tight", pad_inches=0.3)
plt.close()
...
plt.xlabel("frecuencia")
plt.tight_layout()
plt.savefig(FIGS / "07_top_bigramas.png", dpi=120, bbox_inches="tight", pad_inches=0.3)
plt.close()
...
plt.tight_layout()
plt.savefig(FIGS / "08_wordcloud.png", dpi=120, bbox_inches="tight", pad_inches=0.3)
plt.close()
